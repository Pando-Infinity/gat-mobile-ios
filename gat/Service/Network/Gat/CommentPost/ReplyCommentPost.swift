...
struct ReplyCommentPostRequest: APIRequest {
    var path: String { "articles/comments/\(self.replyCommentId)/replies" }
...
struct ReplyCommentPostResponse: APIResponse {
