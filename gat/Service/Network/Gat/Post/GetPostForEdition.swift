//
//  GetPostForEdition.swift
//  gat
//
//  Created by jujien on 10/30/20.
...
struct GetPostForEditionRequest: APIRequest {
    var path: String { "articles/self" }
...
struct GetPostForEditionResponse: APIResponse {
