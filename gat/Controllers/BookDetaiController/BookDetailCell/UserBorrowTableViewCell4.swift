//
//  UserBorrowTableViewCell4.swift
//  gat
//
...
class UserBorrowTableViewCell4: UITableViewCell {
    ...
    func setup(userSharingBook: UserSharingBook) {
        ...
        self.label.text = Gat.Text.ListSharingBook.BORROWING_STATUS_TITLE
    ...
    fileprivate func setupStatus(recordStatus: RecordStatus) {
        switch recordStatus {
        case .waitConfirm:
            self.statusLabel.text = Gat.Text.ListSharingBook.ON_HOLD_AGREE_STATUS_TITLE
            break
        /*case .onHold:
