...
public class activityIndicator: UIView, CAAnimationDelegate {
    ...
    public func completeLoading(success: Bool, completion: Block? = nil) {
        ...
        if success {
            ...
            self.strokeColor = #colorLiteral(red: 0.3803921569, green: 0.5874271393, blue: 0.9953758121, alpha: 1)//UIColor.green
        } else {
            setStrokeFailureShapePath()
            self.strokeColor = #colorLiteral(red: 0.9568627451, green: 0.2352941176, blue: 0.1592293084, alpha: 1)//UIColor.red
        }
