...
public class SheetViewController: UIViewController {
    ...
    fileprivate var containerSize: SheetSize = .fixed(300)
    ...
    fileprivate var orderedSheetSizes: [SheetSize] = [.fixed(300), .fullScreen]
    ...
    fileprivate func height(for size: SheetSize?) -> CGFloat {
