...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _doneButton.backgroundColor = [UIColor colorWithRed:83.0 / 255.0 green:150.0 / 255.0 blue:185.0 / 255.0 alpha:1.0];//[UIColor colorWithRed:47/255.0f green:222/255.0f blue:101/255.0f alpha:1];
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    if (self.valuesArray) {
        ...
        if (self.pickerType == SLTextPickerView) return [[NSAttributedString alloc] initWithString:[self.valuesArray objectAtIndex:row] attributes: @{NSFontAttributeName: [UIFont systemFontOfSize:14.0], NSForegroundColorAttributeName: UIColor.blackColor}];
        
        NSNumber *numberRow = [self.valuesArray objectAtIndex:row];

        NSString* text = [NSString stringWithFormat:@"%i", [numberRow intValue]];
        return [[NSAttributedString alloc] initWithString:text attributes: @{NSFontAttributeName: [UIFont systemFontOfSize:14.0], NSForegroundColorAttributeName: UIColor.blackColor}];
    }
    return nil;
}
